...
namespace ProductBundle\Model\om;
...
use ProductBundle\Model\ProductPeer;
use ProductBundle\Model\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const OM_CLASS = 'ProductBundle\\Model\\Product';

    /** the related TableMap class for this table */
    const TM_CLASS = 'ProductBundle\\Model\\map\\ProductTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \ProductBundle\Model\map\ProductTableMap());
      }
    }
